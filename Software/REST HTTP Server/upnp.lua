...
"NT: upnp:rootdevice\r\n"..
"USN: uuid:c5baf4a1-0c8e-44da-9714-ef"..string.format("%x",node.chipid()).."::upnp:rootdevice\r\n"..
"NTS: ssdp:alive\r\n"..
"SERVER: NodeMCU/20161126 UPnP/1.1 ovoi/0.1\r\n"..
"Location: http://"..wifi.sta.getip().."/HomeAuto.xml\r\n\r\n"
...
UPnPd:on("sent UPnP", function(connection, payLoad) -- Can Delete
         print("sent "..node.heap())
